  ...
  return (
    <section className="relative h-screen bg-black overflow-hidden">
      ...
      <div
        ...
        style={{
          backgroundImage: "url('https://www.lsom.in/assets/images/bopdevghat2025-1024x768.png')",
      ...
      <div className="relative h-full flex flex-col justify-center items-center text-center px-6">
        <div className="max-w-5xl w-full">
          ...
          <h1 className="text-white text-4xl md:text-6xl font-extrabold leading-tight mb-4">
            <span className="block">LSOM  JULY</span>
          ...
          <p className="text-lg md:text-2xl text-gray-200 mb-8 max-w-3xl mx-auto">
            ...
            <span className="text-yellow-400 font-semibold"> Bopdev Ghat</span>
          </p>
          ...
          <div className="inline-flex items-center bg-black/60 backdrop-blur-sm gap-6 px-6 py-4 rounded-lg border border-white/10">
            <div className="text-yellow-400 font-extrabold text-3xl">27</div>
            <div className="text-left border-l border-white/20 pl-4">
              <div className="text-white text-lg font-medium">JULY 2025</div>
              <div className="text-gray-300 text-sm">FLAG-OFF: 5:30 AM @ Bopdev Forest</div>
            </div>
          </div>
